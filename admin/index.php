...
<div id="main_container">
    ...
    <div class="right_header">Welcome <?php echo $myrow2['login'] ?>, <a href="#">Visit site</a> | <a href="#" class="messages">(3) Messages</a> | <a href="exit.php" class="logout">Logout</a></div>
    <div id="clock_a"></div>
    </div>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit" width="400px">
    <thead>
    	<tr>
        	<th scope="col" class="rounded-company"></th>
            <th scope="col" class="rounded">Name</th>
            <th scope="col" class="rounded">Pass</th>
...
<?php
 $dbcon = mysql_connect("localhost", "root"); 
    mysql_select_db("phpform", $dbcon);
	$result = mysql_query("SELECT * FROM users", $dbcon);
		...
		do
{
	printf("<tr>
            ...
            <td>" .$user['password'] ."</td>
            <td>" .$user['role'] ."</td>
            <td><a href='#'><img src='images/user_edit.png' border='0' /></a></td>
            <td><a href='#' class='ask'><img src='images/trash.png'border='0' /></a></td>
        </tr>");
}
